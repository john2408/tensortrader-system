...
class tcn_model:
    ...
    def get_test_train_historical_split(self):
        ...
        self.train_test_timestamps = (
            self.timestamps.iloc[self.lag_length : test_start],
            self.timestamps.iloc[start_test_timestamps:],
        )
    ...
    def get_test_train_batches(self, ts_train: np.ndarray, ts_test: np.ndarray) -> list:
    ...
    def define_tcn_model_v1(self):
        ...
        model.add(
            TCN(
                input_shape=(self.lag_length, self.n_features),
